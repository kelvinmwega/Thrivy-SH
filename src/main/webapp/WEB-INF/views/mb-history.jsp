...
<head>
    ...
    <title>MB History | Thrivy Facilites</title>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    <h2>Master Bedroom Historical Data</h2>
                                    <p>Master Bedroom Door Status, Power Status and Environment Conditions  </p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="${pageContext.servletContext.contextPath}/resources/js/base.js"></script>
<script src="${pageContext.servletContext.contextPath}/resources/js/cogs/mb-history-ctrl.js"></script>
<!-- tawk chat JS
    ============================================ -->
