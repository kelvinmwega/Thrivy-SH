...
<head>
    ...
    <title>Water Supply | Thrivy Facilities</title>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Water Supply</h2>
                                        <p>Water Tank Level and Outside Environment Conditions..</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="${pageContext.servletContext.contextPath}/resources/js/cogs/water_ctrl.js"></script>
<script>
