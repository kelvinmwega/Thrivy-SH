...
<head>
    ...
    <title>Tracker History | Thrivy Facilites</title>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="google-map-single">
                    <div class="line-chart-wp chart-display-nn">
                        <canvas height="100vh" width="180vw" id="speedChart"></canvas>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="google-map-single sm-res-mg-t-30">
                    <div class="line-chart-wp sm-res-mg-t-30 chart-display-nn">
                        <canvas height="100vh" width="180vw" id="signalChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
...
<script src="${pageContext.servletContext.contextPath}/resources/js/base.js"></script>
<script src="${pageContext.servletContext.contextPath}/resources/js/cogs/tracker_hist.js"></script>
<!-- tawk chat JS
    ============================================ -->
