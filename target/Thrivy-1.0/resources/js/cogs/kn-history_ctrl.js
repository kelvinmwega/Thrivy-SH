 ...
 */
var getDevDataURL = ctx + "/getLoraEMDData";
...
function processDevData(data){
    ...
    try {
        ...
        $('#lastsig').text("Signal   : " + data.docs[0].metadata.gateways[0].rssi + " dBm");
        ...
        $('#count').text("Count   : " + data.docs[0].counter);
