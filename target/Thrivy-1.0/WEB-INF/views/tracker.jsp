...
<head>
    ...
    <title>Tracker | Thrivy Facilites</title>
    <meta name="Thrivy Facilites" content="Bringing Your Home to Life.">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    <h2>Car.</h2>
                                    <p>Speed, Location, Heading, Environment Conditions, Door and Power Status..</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="google-map-single">
                    <h2>Speed (Km/hr)</h2>
                    <h3 id="speed-textfield">loading ...</h3>
                    <canvas width=500vw height=200vh id="speedGauge"></canvas>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="google-map-single sm-res-mg-t-30">
                    <h2>Signal ()</h2>
                    <h3 id="signal-textfield">loading ...</h3>
                    <canvas width=500vw height=200vh id="signalGauge"></canvas>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="footer-copy-right">
                    <p> © 2019 Powered By <a href="https://www.ibm.com/cloud/"> IBM Cloud </a>.</p>
                </div>
            </div>
        </div>
    </div>
...
<script src="${pageContext.servletContext.contextPath}/resources/js/cogs/tracker_ctrl.js"></script>
<!-- tawk chat JS
    ============================================ -->
<%--<script src="${pageContext.servletContext.contextPath}/resources/js/tawk-chat.js"></script>--%>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDIXEnt978JczAkDOVWLpYdjAA-1nkQhWk&callback=initMap" async defer></script>

<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function(event) {
        selectDev("865905027550908");
    });
