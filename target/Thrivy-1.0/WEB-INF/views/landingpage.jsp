...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/css/bootstrap-select/bootstrap-select.css">
    <!-- normalize CSS
		============================================ -->
                ...
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        ...
                        <div class="bootstrap-select fm-cmp-mg">
                            <select class="selectpicker" id="devTypeSelect" onchange="procDevTypeSelect();">
                                <option value="00">All</option>
                                <option value="01">Radio Towers</option>
                                <option value="10">Fence Monitors</option>
                                <option value="11">Visitor Trackers</option>
                                <%--<option>Park Rangers</option>--%>
                            </select>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        ...
                        <div class="bootstrap-select fm-cmp-mg">
                            <select class="selectpicker" id="deviceSelector" onchange="procDevSelect();">
...
<!-- bootstrap select JS
     ============================================ -->
<script src="${pageContext.servletContext.contextPath}/resources/js/bootstrap-select/bootstrap-select.js"></script>
<!--  todo JS
    ============================================ -->
