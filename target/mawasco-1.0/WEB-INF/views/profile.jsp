        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    ...
                    <li><a data-toggle="tab" href="#billing"><i class="notika-icon notika-finance"></i> Billing</a>
                    </li>
                    <li class="active"><a data-toggle="tab" href="#company"><i class="notika-icon notika-settings"></i> Company</a>
                    </li>
                </ul>
                <div class="tab-content custom-menu-content">
                    ...
                    <div id="billing" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                    ...
                    <div id="company" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
